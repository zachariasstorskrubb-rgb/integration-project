...
camera.position.set(1, 0.3, -1); // keep previous camera
...
loader.load('./christmas_decoration.glb', (gltf) => {
  model = gltf.scene;
  scene.add(model);
  ...
  model.position.y -= center.y-0.2; // slightly lower
...
addFloatingLabel(
  new THREE.Vector3(0.07, 0.17, 0.05),
  `A nativity scene is a depiction of the birth of Jesus Christ, a central story in Christianity, and is traditionally displayed during the Christmas season. It typically shows the infant Jesus lying in a manger, surrounded by his mother Mary, his earthly father Joseph, angels, shepherds, and animals, with the Three Wise Men sometimes included. The scene is based on biblical accounts and symbolizes themes such as humility, peace, and hope, emphasizing that Jesus was born in modest circumstances. Nativity scenes can be found in churches, homes, and public spaces, and they may appear as figurine displays or live reenactments, a tradition that dates back to the 13th century.`,
  'images/nativity-scene.jpg',   // top image
  'images/jesusbirth.jpg'   // bottom image
);