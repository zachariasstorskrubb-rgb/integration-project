...
loader.load('./black_shoe.glb', (gltf) => {
  model = gltf.scene;
  scene.add(model);
  ...
  model.position.y -= center.y-0.1; // slightly lower
...
addFloatingLabel(
  ...
  `The Nike Air Force 1 was designed by Bruce Kilgore in 1982. The name is a reference to Air Force One, the plane that carries the President of the United States. Nike Air Force 1s were ubiquitous in Harlem, New York, giving rise to the nickname "Uptowns". Nike Air Force is a range of athletic shoes made by Nike. It was created by designer Bruce Kilgore and was the first basketball shoe to use Nike's "Air" technology. The shoe is offered in low-, mid- and high-top styles.`,
  'images/nikes.jpg',   // top image
  'images/bruce.jpg'   // bottom image
);
